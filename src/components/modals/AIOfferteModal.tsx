...
export default function AIOfferteModal({ open, onOpenChange, onSuccess }: AIOfferteModalProps) {
  ...
  const renderMediaStep = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className="cursor-pointer hover:bg-muted/50 transition-colors" onClick={handleCameraCapture}>
        ...
        <Card className="cursor-pointer hover:bg-muted/50 transition-colors" onClick={handleDocumentUpload}>
          <CardContent className="flex flex-col items-center justify-center p-6 text-center">
