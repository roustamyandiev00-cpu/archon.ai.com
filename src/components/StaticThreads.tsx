...
"transition-all duration-300 ease-in-out",
 ...
 className={cn(
"flex items-center gap-2 px-3 py-2 rounded-xl bg-card shadow-sm border border-border/50",
"hover:bg-card shadow-sm transition-all duration-200 text-foreground",
 ...
 className="flex gap-2 p-1 bg-card shadow-sm rounded-xl border border-border/50"
 >
 <button
 id="threads-tab"
 type="button"
...
"w-full text-left p-3 rounded-xl border transition-all duration-200",
 ...
 :"bg-card shadow-sm border-border/50 hover:border-border/50 hover:bg-background"
 )}
 >
 ...
 className="w-full text-left p-3 rounded-xl border border-border/50 bg-card shadow-sm hover:border-border/50 hover:bg-background transition-all duration-200"
 >
 ...
 variant="outline"
 size="sm"
 className="w-full bg-card shadow-sm border-border/50 hover:bg-card shadow-sm text-foreground"
