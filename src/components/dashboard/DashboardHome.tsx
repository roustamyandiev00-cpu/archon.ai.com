...
function CustomTooltip({
 ...
 return (
 <div className="bg-popover/90 px-3 py-2 rounded-lg shadow-lg border border-border/50 text-popover-foreground">
...
export default function DashboardHome({
 ...
 {/* Welcome Banner */}
 <div className="relative overflow-hidden rounded-2xl bg-card shadow-sm border border-border/50 p-6 text-foreground">
 {/* Animated Border */}
 <div
 ...
 <div
 className="h-5 w-56 rounded bg-muted animate-pulse"
 aria-hidden="true"
 />
 )}
 ...
 <Button
 variant="outline"
 className="bg-card shadow-sm border-border/50 text-foreground hover:bg-card shadow-sm transition-all duration-200"
 onClick={() => {
...
'absolute inset-0 rounded-2xl bg-gradient-to-br opacity-0 group-hover:opacity-100 transition-opacity duration-300',
 ...
 />
 <div className="relative bg-card shadow-sm border border-border/50 rounded-2xl p-5 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 hover:bg-card shadow-sm">
...
'flex items-center gap-1 text-sm font-medium px-2 py-1 rounded-full',
 ...
 {/* Revenue Chart */}
 <div className="lg:col-span-3 bg-card shadow-sm border border-border/50 rounded-2xl p-6 hover:shadow-xl transition-all duration-300">
 ...
 {/* Deals Chart */}
 <div className="lg:col-span-2 bg-card shadow-sm border border-border/50 rounded-2xl p-6 hover:shadow-xl transition-all duration-300">
 ...
 {/* Recent Activity */}
 <div id="recent-activity"className="bg-card shadow-sm border border-border/50 rounded-2xl p-6 hover:shadow-xl transition-all duration-300">
 <div className="flex items-center justify-between mb-6">
 <div>
 ...
 className="flex items-start gap-4 p-3 rounded-xl hover:bg-card shadow-sm transition-colors duration-200"
 >
 ...
 {/* Tasks */}
 <div className="bg-card shadow-sm border border-border/50 rounded-2xl p-6 hover:shadow-xl transition-all duration-300">
 <div className="flex items-center justify-between mb-6">
 <div>
 ...
 <div
 key={task.title}
 className="p-4 rounded-xl border border-border/50 hover:border-border/50 hover:shadow-md transition-all duration-200 bg-card shadow-sm"
 >
 ...
 className="flex flex-col items-center gap-2 p-4 rounded-xl border border-border/50 hover:border-border/50 hover:shadow-lg transition-all duration-200 group bg-card shadow-sm outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
 >
 <div
 className={cn(
