...
export default function DashboardHeader({
 ...
 return (
 <header className="sticky top-0 z-30 bg-background border-b border-border/20">
 ...
 className="lg:hidden p-2 rounded-lg hover:bg-card shadow-sm transition-colors outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
 >
 ...
 className="hidden md:flex h-9 w-44 items-center rounded-md border border-border/50 bg-card shadow-sm px-3"
 >
 ...
 className="md:hidden h-9 max-w-[42vw] shrink-0 items-center rounded-md border border-border/50 bg-card shadow-sm px-3 flex"
 >
 <span className="truncate text-sm font-medium text-foreground">{activePageLabel}</span>
 </div>
 ...
 className="w-full h-9 rounded-md border border-border/50 bg-card shadow-sm pl-10 pr-3 text-sm text-left text-muted-foreground hover:bg-card shadow-sm transition-colors outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
 >
 ...
 <kbd className="rounded border border-border/50 bg-background px-1.5 py-0.5 font-mono">Ctrl</kbd>
 <kbd className="rounded border border-border/50 bg-background px-1.5 py-0.5 font-mono">K</kbd>
 </span>
 </span>
 </button>
 </div>
 ...
 className={`hidden sm:flex items-center justify-center w-9 h-9 rounded-lg border border-border/50 bg-card shadow-sm transition-opacity duration-200 ${pageSwitching ?'opacity-100':'opacity-0'}`}
 >
 <Loader2 className="w-4 h-4 animate-spin text-muted-foreground"/>
 </div>

 {themeMounted ? (
 <LiveClock className="hidden sm:block text-sm font-medium text-foreground bg-card shadow-sm px-3 py-1.5 rounded-lg border border-border/50"/>
 ) : (
 <span
 className="hidden sm:block text-sm font-medium text-foreground bg-card shadow-sm px-3 py-1.5 rounded-lg border border-border/50"
 ...
 title="Wissel thema"
 className="p-2 rounded-lg transition-all duration-200 border border-border/50 bg-card shadow-sm hover:bg-card shadow-sm text-foreground outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
 >
 ...
 variant="ghost"
 size="icon"
 className="relative hover:bg-card shadow-sm"
 >
 <Bell className="w-5 h-5"/>
 {unreadNotifications > 0 ? (
 <span
 aria-hidden="true"
 className="absolute -top-1 -right-1 w-3 h-3 bg-red-500 rounded-full border-2 border-border/50"
 />
 ) : null}
 </Button>
 </DropdownMenuTrigger>
 ...
 variant="ghost"
 size="icon"
 className="hidden sm:inline-flex hover:bg-card shadow-sm"
 >
 ...
 variant="ghost"
 size="icon"
 className="bg-card shadow-sm hover:bg-card shadow-sm text-foreground border border-border/50 shadow-lg transition-all duration-200"
 >
