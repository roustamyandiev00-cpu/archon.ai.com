...
function PaymentRow({ betaling }: { betaling: Betaling }) {
  ...
  return (
    <div className="group flex items-center justify-between p-4 bg-card/60 backdrop-blur-xl border border-border/30 rounded-xl hover:shadow-lg hover:bg-card/75 transition-all duration-300">
