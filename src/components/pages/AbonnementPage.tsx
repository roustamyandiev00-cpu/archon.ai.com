...
export default function AbonnementPage() {
 ...
 key={plan.naam}
 className={cn(
"relative bg-card shadow-sm border rounded-2xl p-6 hover:shadow-xl hover:bg-card shadow-sm transition-[background-color,box-shadow,border-color] duration-300",
 plan.current
