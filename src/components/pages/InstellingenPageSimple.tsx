  ...
  return (
    <div className="flex flex-col h-full bg-background overflow-hidden relative">
      <div className="w-full max-w-[1400px] mx-auto p-4 md:p-8 flex flex-col md:flex-row gap-8 min-h-screen">
        ...
        <div className="w-full md:w-64 flex-shrink-0 space-y-6 hidden md:block border-r pr-6">
          <div className="mb-6">
                ...
                <CardContent className="p-0">
                  ...
                  <div className="p-6 flex flex-col md:flex-row gap-6 items-start md:items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="h-12 w-12 rounded-lg bg-[#262626] flex items-center justify-center flex-shrink-0 relative overflow-hidden">
                  ...
                  <div className="p-6 flex flex-col md:flex-row gap-6 items-start md:items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="h-12 w-12 rounded-lg bg-white border shadow-sm flex items-center justify-center flex-shrink-0">
              ...
              <Card className="shadow-sm border-border">
                ...
                <CardContent className="p-6">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    ...
                    >
                      <div className="aspect-[1/1.4] bg-gradient-to-br from-muted to-card rounded-lg border shadow-sm p-4 relative overflow-hidden">
                        ...
                        <div className="w-full h-8 bg-primary/10 rounded mt-auto absolute bottom-4 left-4 right-4 w-[calc(100%-2rem)]"></div>
                      </div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    {['modern', 'classic', 'minimal'].map((style) => (
                      ...
                      >
                         <div className="aspect-[1/1.4] bg-muted/50 rounded-lg border shadow-sm p-4 relative flex items-center justify-center">
