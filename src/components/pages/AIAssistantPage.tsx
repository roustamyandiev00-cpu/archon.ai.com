...
'Authorization': `Bearer ${session?.access_token}`
 ...
 }, [autoSpeakResponses, handleAssistantAction, isLoading, isRecording, messages, speakText, stopRecording])
 ...
 className={cn(
 autoSpeakResponses ?'bg-violet-600 hover:bg-violet-700 text-white':'border-border/50 text-muted-foreground hover:text-foreground'
 )}
 ...
 className={cn(
 voiceQuestionMode ?'bg-rose-600 hover:bg-rose-700 text-white':'border-border/50 text-muted-foreground hover:text-foreground'
 )}
 ...
 {/* Chat Main Area */}
 <Card className="flex-1 bg-card shadow-sm border-border/50 flex flex-col overflow-hidden relative">
...
"max-w-[80%] p-4 rounded-2xl text-sm leading-relaxed shadow-sm",
 ...
 type="button"
 className={cn(
'inline-flex h-7 w-7 items-center justify-center rounded-md border border-border/50 transition-colors',
...
"mt-2 text-[10px] opacity-50",
 ...
 key={item}
 type="button"
 className="flex w-full items-center justify-between rounded-xl border border-border/50 bg-background p-3 text-left text-xs text-foreground transition-all hover:bg-violet-500/5 hover:border-violet-500/30 group"
