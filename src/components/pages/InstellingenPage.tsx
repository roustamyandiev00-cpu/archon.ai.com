  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        <TabsList className="bg-card/60 backdrop-blur-xl border border-border/30 p-1 rounded-xl flex-wrap">
          <TabsTrigger
            value="profiel"
          ...
          <div className="bg-card/60 backdrop-blur-xl border border-border/30 rounded-2xl p-6">
            ...
            <div className="flex items-center gap-4 mb-6 pb-6 border-b border-border/30">
              <div className="relative">
                ...
                <label className="absolute bottom-0 right-0 w-8 h-8 rounded-full bg-card border border-border/30 shadow-md hover:bg-muted/40 cursor-pointer flex items-center justify-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 bg-background/30 border-border/30"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    disabled
                    className="pl-10 bg-background/30 border-border/30 opacity-60"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  >
                    <SelectTrigger className="pl-10 bg-background/30 border-border/30">
        ...
        <TabsContent value="bedrijf">
          <div className="bg-card/60 backdrop-blur-xl border border-border/30 rounded-2xl p-6">
            ...
            {/* Logo */}
            <div className="flex items-center gap-4 mb-6 pb-6 border-b border-border/30">
              <div className="w-16 h-16 rounded-xl bg-muted border border-border/30 flex items-center justify-center overflow-hidden">
              ...
              <div>
                <label className="cursor-pointer">
                  <Button variant="outline" size="sm" className="bg-card/60 border-border/30" asChild>
                    <span>
          ...
          <div className="bg-card/60 backdrop-blur-xl border border-border/30 rounded-2xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {integraties.map((integratie) => (
                <div
                  key={integratie.naam}
                  className="flex items-center justify-between p-4 rounded-xl bg-card/40 border border-border/30 hover:border-border/50 hover:bg-card/60 transition-all"
                >
        ...
        <TabsContent value="email">
          <div className="bg-card/60 backdrop-blur-xl border border-border/30 rounded-2xl p-6">
            ...
            {/* Gmail Settings */}
            {smtpProvider === 'gmail' && (
              <div className="space-y-4 p-4 rounded-xl bg-card/40 border border-border/30">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-10 pr-10 bg-background/30 border-border/30"
                      />
                      <button
                        type="button"
            ...
            <div className="mt-8 pt-8 border-t border-border/30">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 rounded-xl bg-card/40 border border-border/30 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <Badge variant="secondary" className="text-[10px] bg-slate-500/10 text-slate-500 border-none">NIET VERBONDEN</Badge>
                    </div>
                  </div>
                  <Button size="sm" variant="outline" className="border-border/30" onClick={() => toast({ title: "OAuth", description: "Doorsturen naar Google login..." })}>
                    Koppelen
                  </Button>
                </div>
                ...
                <div className="p-4 rounded-xl bg-card/40 border border-border/30 flex items-center justify-between">
                  ...
                  <Button size="sm" variant="outline" className="border-border/30" onClick={() => toast({ title: "OAuth", description: "Doorsturen naar Microsoft login..." })}>
                    Koppelen
                  </Button>
                </div>
              </div>
        ...
        <TabsContent value="betalingen">
          <div className="bg-card/60 backdrop-blur-xl border border-border/30 rounded-2xl p-6">
            ...
            {/* Test Mode Toggle */}
            <div className="flex items-center justify-between p-4 rounded-xl bg-card/40 border border-border/30 mb-6">
              <div className="flex items-center gap-3">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 bg-background/30 border-border/30 font-mono text-sm"
                  />
                  <button
                    type="button"
        ...
        <TabsContent value="historie">
          <div className="bg-card/60 backdrop-blur-xl border border-border/30 rounded-2xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Oude Facturen */}
              <Card className="bg-slate-900/40 border-white/5 hover:border-amber-500/30 transition-all group">
                <CardHeader>
                ...
                <CardContent className="space-y-4">
                  <div className="p-4 rounded-xl border border-dashed border-white/10 flex flex-col items-center justify-center gap-2 group-hover:bg-white/5 transition-colors cursor-pointer" onClick={() => document.getElementById('import-facturen')?.click()}>
                    <UploadCloud className="w-8 h-8 text-slate-500 group-hover:text-amber-500 transition-colors" />
                    <span className="text-xs text-slate-400">Sleep bestanden hierheen of klik om te bladeren</span>
                  ...
                  <Button variant="outline" className="w-full border-white/10" onClick={() => window.location.href='/documenten'}>Bekijk in Kluis</Button>
                </CardContent>
              </Card>

              {/* Oude Offertes */}
              <Card className="bg-slate-900/40 border-white/5 hover:border-blue-500/30 transition-all group">
                <CardHeader>
                  <CardTitle className="text-base flex items-center gap-2">
                ...
                <CardContent className="space-y-4">
                  <div className="p-4 rounded-xl border border-dashed border-white/10 flex flex-col items-center justify-center gap-2 group-hover:bg-white/5 transition-colors cursor-pointer" onClick={() => document.getElementById('import-offertes')?.click()}>
                    <UploadCloud className="w-8 h-8 text-slate-500 group-hover:text-blue-500 transition-colors" />
                    <span className="text-xs text-slate-400">PDF of Word bestanden</span>
                  ...
                  <Button variant="outline" className="w-full border-white/10">Batch Beveiliging</Button>
                </CardContent>
              </Card>

              {/* Klantgegevens */}
              <Card className="bg-slate-900/40 border-white/5 hover:border-emerald-500/30 transition-all group">
                <CardHeader>
                  <CardTitle className="text-base flex items-center gap-2">
                ...
                <CardContent className="space-y-4">
                  <div className="p-4 rounded-xl border border-dashed border-white/10 flex flex-col items-center justify-center gap-2 group-hover:bg-white/5 transition-colors cursor-pointer" onClick={() => document.getElementById('import-klanten')?.click()}>
                    <UploadCloud className="w-8 h-8 text-slate-500 group-hover:text-emerald-500 transition-colors" />
                    <span className="text-xs text-slate-400">Upload CSV of Excel bestand</span>
                  ...
                  <Button variant="outline" className="w-full border-white/10">Download Sjabloon</Button>
                </CardContent>
              </Card>
            </div>

            {/* AI Migration Assistant Section */}
            <div className="mt-8 p-6 rounded-2xl bg-linear-to-br from-violet-600/10 to-blue-600/10 border border-violet-500/20 relative overflow-hidden">
