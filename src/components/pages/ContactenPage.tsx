...
export function ContactenPage({ autoOpenCreate }: { autoOpenCreate?: boolean }) {
 ...
 className="pl-10 bg-card shadow-sm border-border/50 focus-visible:ring-blue-500/20 h-11"
 />
 </div>
 ...
 className="group relative bg-card shadow-sm border border-border/50 rounded-2xl p-5 hover:border-blue-500/50 hover:shadow-xl hover:shadow-blue-500/5 transition-all cursor-pointer"
 >
...
"w-12 h-12 rounded-xl bg-gradient-to-br flex items-center justify-center text-white font-bold text-lg shadow-lg",
 ...
 key={contact.id}
 onClick={() => handleContactClick(contact)}
 className="group cursor-pointer border-border/20 hover:bg-muted"
 >
 <TableCell>
