...
'Content-Type':'application/json',
 ...
 className="pl-10 bg-background border-border/50 focus-visible:ring-emerald-500/20"
 />
 </div>
 ...
 return (
 <TableRow key={inkomst.id} className="border-border/20 hover:bg-muted transition-colors">
