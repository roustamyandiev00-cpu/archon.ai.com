...
export default function TimesheetsPage({ autoOpenCreate }: { autoOpenCreate?: boolean }) {
 ...
 <div className="flex items-center gap-2 px-4 py-2 bg-card shadow-sm border border-border/50 rounded-xl">
 ...
 <TableRow key={entry.id} className="border-border/20 hover:bg-muted transition-colors">
 ...
 <TableCell>
 <Badge variant="outline"className="bg-muted border-border/50 text-foreground/80 font-medium">
 {entry.uren} uur
 </Badge>
 </TableCell>
 <TableCell>
