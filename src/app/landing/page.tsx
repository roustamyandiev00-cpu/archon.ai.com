        ...
        <div className="mx-auto max-w-7xl px-4 py-20 md:py-28">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <Card className="relative shadow-2xl border-border/60 bg-card/70 backdrop-blur-md">
                <CardHeader>
      ...
      <section id="features" className="border-t border-border/60">
        <div className="mx-auto max-w-7xl px-4 py-16 md:py-20">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((f) => (
              <Card key={f.title} className="bg-card/70 backdrop-blur-md border-border/60">
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 md:py-20">
          ...
          <div id="pricing" className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
            {pricing.map((p) => (
              <Card
                key={p.name}
                className={`bg-card/70 backdrop-blur-md border-border/60 ${p.highlight ? "ring-2 ring-primary" : ""}`}
              >
                <CardHeader>
